...
int main1(){
    ...
    for(i=0; i<K; i++){
        ...
        string fileName = "C:\\TestData1\\groupResult\\group";
        strstream ss;
        string s;
        ss << i;
        ss >> s;
...
int main()
{
	...
	config.regex_file = "C:\\TestData1\\regex0.txt";
	config.dot_file = "C:\\TestData1\\dfile0.txt";
	config.out_file = "C:\\TestData1\\ofile0.txt";
...
/*
    ...
    */
    ...
    FILE *out_file1=fopen("C:\\TestData1\\m1file.txt","w");
    ...
    FILE *out_file2=fopen("C:\\TestData1\\m2file.txt","w");
    for(int num=1; num<=j; num++)
    {
